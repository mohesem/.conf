...
theme.vol_no = theme.dir .. "/icons/volume_off.png"
theme.vol_mute = theme.dir .. "/icons/volume_mute.png"
    ...
    settings = function()
        if mpd_now.state == "play" then
            ...
            artist = " " .. mpd_now.artist ..
                         markup("#777777", " <span font='Dank Mono 2'> </span>|<span font='Dank Mono 5'> </span>")
            mpdicon:set_image(theme.play)
        elseif mpd_now.state == "pause" then
            title = "mpd "
            artist = "paused" .. markup("#777777", " |<span font='Dank Mono 5'> </span>")
...
local volumebg = wibox.container.background(theme.volume.bar, 'eeeeee', gears.shape.rectangle)
...
local bar_spr = wibox.widget.textbox(markup.font("Dank Mono 3", " ") .. markup.fontfg(theme.font, "#ffffff", "|") ..
